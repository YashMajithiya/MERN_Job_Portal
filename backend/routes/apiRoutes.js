  //Variable for calling Expressjs
  const express = require("express");
  //Variable for calling MongoDB
  const mongoose = require("mongoose");
  //Variable for jwtAuth Library
  const jwtAuth = require("../lib/jwtAuth");
  //Variable for calling user from database
  const User = require("../db/User");
  //Calling JobApplicant table From database
  const JobApplicant = require("../db/JobApplicant");
  //Calling Recruiter table from database
  const Recruiter = require("../db/Recruiter");
  const Job = require("../db/Job");
  //Calling Application Table from Database
  const Application = require("../db/Application");
  //Calling rating Table From Database
  ...
  router.get("/jobs", jwtAuth, (req, res) => {
    ...
    let user = req.user;
    //Declaring Variable find Parameters
    let findParams = {};
    //Declaring Variable sort parameters
    let sortParams = {};
